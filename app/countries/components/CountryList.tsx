        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {filteredCountries.map((country) => (
            <Link 
              ...
              className="group bg-white border border-gray-100 hover:border-zippcall-light-blue rounded-xl p-5 transition-all hover:shadow-md relative overflow-hidden"
            >
