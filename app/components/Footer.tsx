  ...
  return (
    <footer className="bg-zippcall-blue text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-zippcall-yellow transition-colors">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-zippcall-yellow">Product</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-zippcall-yellow">Support</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-zippcall-yellow">Company</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-zippcall-light-blue/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
